...
class Edge_Detect:
    ...
    def got_images(self, img1, img2, img3):
        ...
        self.yt_hough = cv2.HoughLinesP(self.yt_edges, rho=1, theta=numpy.pi/180, threshold=3, minLineLength=25, maxLineGap=25)
        self.ylw_hough = cv2.HoughLinesP(self.ylw_edges, rho=1, theta=numpy.pi/180, threshold=3, minLineLength=25, maxLineGap=25)
